...
% sequence generator
%
\newcommandx*{\makeseq}[3][1=\, , 2=\idfunc]{%
...
\newcommand{\PMF}[1]{\mathcal{P}\left(\makeseq[\cap][\set]{#1} \right)}
...
\newcommand{\Bin}{}   % binomial
\newcommand{\Geom}{}  % geometric
\newcommand{\NBin}{}  % negative binomial
\newcommand{\HGeom}{} % hypergeometric
\newcommand{\Pois}{} % poisson
\newcommand{\Unif}{}   % uniform
