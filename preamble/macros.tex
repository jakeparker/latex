% TODO: migrate from LaTeX to LuaTex! 
%   - (1.0 version is finally out)
%   - (also support for unicode symbols! (via unicode-math.sty) (i.e. type '\sigma + tab' --> σ instead of \sigma)!
%   - (I've had my fill of Tex... to say the least... )
...
\newcommand{\suchthat}{\bm{\mathrel{\mathlarger{\hollowcolon}}}}
...
\newcommand{\indicator}[1]{\mathds{#1}}
...
\newcommand{\optimal}[1]{#1^{\varhexstar}} % \ast
